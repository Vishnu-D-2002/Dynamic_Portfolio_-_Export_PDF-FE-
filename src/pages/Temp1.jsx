...
const Temp1 = () => {
  ...
  return (
    ...
    <div id='box'>
        ...
        <div id='top-center'>
           <strong className='underline top'> {studentDetails.firstname} {studentDetails.lastname}</strong>
        <a className='top' href={`mailto:${studentDetails.email}`}>{studentDetails.email}</a>
